...
Depois é registrar no Claude Code e conversar: *"varre minhas empresas"*, *"o que chegou acima de 7?"*, *"prepara a candidatura da vaga 42"*. Setup, configuração e a lista completa de ferramentas estão na [documentação](https://albertosca.github.io/moonlighter/pt/).
...
O moonlighter roda localmente e chama o seu LLM — não existe servidor nem conta do moonlighter. Seu pipeline mora num arquivo SQLite local; o que sai da sua máquina é o que vai para o LLM e para as APIs que você configura. Ver [PRIVACY.md](https://github.com/albertosca/moonlighter/blob/main/PRIVACY.md) e [DISCLAIMER.md](https://github.com/albertosca/moonlighter/blob/main/DISCLAIMER.md).
