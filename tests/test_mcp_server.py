...
async def test_setup_email_calls_gmail_flow():
    ...
    with (
        patch("candidatador.mcp_server.setup_gmail_service") as mock_setup,
        patch(
...
async def test_sync_email_responses_returns_summary(tmp_db):
    ...
    with (
        patch("candidatador.mcp_server.sync_responses", new=AsyncMock(return_value=fake_updates)),
        patch(
            "candidatador.mcp_server.load_config",
            return_value={
                "email": {
...
async def test_sync_email_responses_empty_inbox(tmp_db):
    ...
    with (
        patch("candidatador.mcp_server.sync_responses", new=AsyncMock(return_value=[])),
        patch(
            "candidatador.mcp_server.load_config",
            return_value={
                "email": {
