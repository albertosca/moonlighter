...
1. **Scan** — busca vagas no Greenhouse, Lever, Ashby, Recruitee, Workable, SmartRecruiters e LinkedIn para a lista de empresas que você configura, além de portais remote-first opcionais (RemoteOK, Remotive, WeWorkRemotely, HN Who's Hiring) e Gupy, ambos desativados por padrão (config-gated).
...
| `moonlighter-full` | `moonlighter.server` | Servidor FastMCP — conecta todos os pacotes |
